...
option \texttt{-\/-csv-proj4} need to be set to interpret this data. If
this option is set, it will also be used for output DEMs, unless the
option \texttt{-\/-t\_srs} is specified.
